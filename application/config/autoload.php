...
*/
$autoload['libraries'] = array('form_validation','pagination','database','session','table','upload','email','calendar','parser');
...
*/
$autoload['helper'] = array('form','url','array','cookie','date','html','security','string','text','email','download');
