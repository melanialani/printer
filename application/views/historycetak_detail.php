                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <br/>
                                                                <small><a href="<?= site_url('order/deleteImage/'.$data->id_image); ?>" class="text-danger">Delete Gambar</a></small>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-10">
                                                                <div class="form-group">
                                                                    ...
                                                                    <small><a href="<?= site_url('order/deleteComment/'.$value['id_comment']); ?>" class="text-danger">Delete Comment</a></small>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    <?php } } ?>
