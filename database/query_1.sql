...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 12, 2018 at 03:31 AM
...
--
-- Table structure for table `ukurang_barang`
--

CREATE TABLE `ukurang_barang` (
  `id` int(11) NOT NULL,
...
--
-- Indexes for table `ukurang_barang`
--
ALTER TABLE `ukurang_barang`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `ukurang_barang`
--
ALTER TABLE `ukurang_barang`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
